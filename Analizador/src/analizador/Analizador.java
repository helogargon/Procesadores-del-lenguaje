...
//            for (int i = 0; i < argv.length; i++) {
                ...
                try {
                    lexico = new AnalizadorLexico(new java.io.FileReader("/media/miguel/0914-ABE8/Universidad/3º/Procesadores del Lenguaje/Practica grupal 2/Procesadores-del-lenguaje/Analizador/src/analizador/input1.txt"));
